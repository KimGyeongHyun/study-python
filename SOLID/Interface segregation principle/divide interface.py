...
class TextReader:
    ...
    def add_text(self, text: IText):    # IText 인터페이스가 기존 역할 수행
...
email = Email("hello are you alright?", "@namver.com")
text_message = TextMessage("this is text message")
memo = Memo("this is memo")
