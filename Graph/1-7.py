...
def create_station_nodes(input_file):
    ...
    with open(input_file, 'rt', encoding='UTF8') as stations_raw_file:  # 'rt', encoding='UTF8' 한국어 때문에 추가
        for line in stations_raw_file:  # 파일을 한 줄씩 받아온다
            ...
            for name in subway_line:
                ...
                # 코드를 쓰세요
                station_node = StationNode(station_name)
                stations[station_name] = station_node

                # 과제 해설
                # 같은 이름의 지하철 역일 경우 넘어간다
