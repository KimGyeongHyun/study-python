...
class BinarySearchTree:
    ...
    def delete(self, data):
        ...
        # 보통 successor 는 부모 노드의 왼쪽 자식이지만 삭제할 노드의 오른쪽 자식 트리에 노드가 하나뿐이라면 오른쪽 자식이 될 수 있음
        # 위의 예외사항을 체크하지 못함
        # 파이썬은 가비지 컬랙터를 통해 참조가 안 된 변수들은 자동으로 삭제한다 함 (None 지정 불필요)
        ...
        # successor 노드 오른쪽 자식 있으면 부모 붙혀줌
