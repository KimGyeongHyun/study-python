def get_parent_index(complete_binary_tree, index):
    ...
    # index // 2 를 생각하지 못함
    # 임시 index(parent_index) 를 아래처럼 설정하면 직관적임
...
def get_left_child_index(complete_binary_tree, index):
    ...
    if len(complete_binary_tree) - 1 < index*2:
        return None

    return index*2

    # 임시 index(left_child_inde) 를 아래처럼 설정하면 직관적임
...
def get_right_child_index(complete_binary_tree, index):
    ...
    if len(complete_binary_tree) - 1 < index*2 + 1:
        return None
